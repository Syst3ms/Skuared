...
package fr.syst3ms.skuared.util.astar;
...
public class AStar {
	...
	private static boolean isBestFirst;
	...
	public AStar(Location start, Location end, int range, boolean ignoreDamage, boolean isPlayer, boolean isBestFirst) {
		this.ignoreDamage = ignoreDamage;
		this.isPlayer = isPlayer;
		AStar.isBestFirst = isBestFirst;
	...
	public static boolean isBestFirst() {
		return isBestFirst;
	}
