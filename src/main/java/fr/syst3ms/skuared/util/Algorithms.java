...
public class Algorithms {
	...
	private static void parseError(String error) {
		ReflectionUtils.setStaticField(ExprParse.class, "lastError","[Skuared parsing] " + error);
}

	private static void evalError(String error) {
		ReflectionUtils.setStaticField(ExprParse.class, "lastError","[Skuared evaluation] " + error);
	}
